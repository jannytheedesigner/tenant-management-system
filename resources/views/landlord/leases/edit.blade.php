    ...
    <div class="p-6 max-w-3xl mx-auto">
        ...
        <form action="{{ route('leases.update', [$property->id, $lease->id]) }}" method="POST"
            ...
            <div>
                ...
                <input type="number" id="tenant_id" name="tenant_id" value="{{ old('tenant_id', $lease->tenant_id) }}"
            ...
            <div class="flex justify-end">
                ...
                <button type="submit" class="px-4 py-2 bg-[#12C6B0] text-white rounded-lg shadow hover:bg-primary-700">Update Lease</button>
            </div>
        </form>
    </div>
</x-app-layout>
